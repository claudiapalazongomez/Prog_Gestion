...
public class ListadoClientes implements WindowListener, ActionListener
{
	...
	{	
		...
		try
		{
			...
			table.addHeaderCell(new Cell().add(new Paragraph("Apellido 1").setFont(fontHeader).setBold()));
			table.addHeaderCell(new Cell().add(new Paragraph("Apellido 2").setFont(fontHeader).setBold()));
